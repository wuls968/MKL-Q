...
| Benchmark tooling | `test_mklq_benchmark_harness.py`, benchmark helper `py_compile`, summary JSON parse, `check_performance_evidence.py`, `check_metal_evidence.py`, `run_cpu_sampling_counter_probe.py`, `summarize_cpu_sampling_counters.py`, `check_cpu_sampling_counter_docs.py`, `run_metal_runtime_counter_probe.py`, `summarize_metal_runtime_counters.py`, `check_metal_runtime_counter_docs.py` | Benchmark case/schema/report changes, tracked clean CPU evidence quality, tracked experimental Metal evidence boundary quality, bounded runtime counter evidence parsing, public counter-summary rendering, and counter-doc drift detection | Does not prove current runtime speed unless real benchmark rows run |
