...
| local-metal-controlled-swap-q16-2026-07-10 | local_tuning_evidence | Apple M5, 10 logical cores, 16 GiB RAM, macOS 26.5.2 | qpp-cpu, mklq-metal | controlled-swap-state | 16 | shot_counts=1024; repeats=3; warmups=1; layers=6; isolate_rows=true | ok=2 | benchmarks/mklq/results/local-metal-controlled-swap-q16-2026-07-10.json sha256=f7ac23cb4f90 |
...
| local-metal-four-qubit-resident-q20-2026-07-11 | local_tuning_evidence | Apple M5, 10 logical cores, 16 GiB RAM, macOS 26.5.2 | qpp-cpu, mklq-cpu, mklq-metal | four-qubit-state | 20 | shot_counts=1024; repeats=2; warmups=1; layers=8; isolate_rows=true | ok=3 | benchmarks/mklq/results/local-metal-four-qubit-resident-q20-2026-07-11.json sha256=7342a789544a |
...
| local-metal-controlled-swap-q16-2026-07-10 | `mklq_metal_elapsed_seconds_median.controlled_swap_state_q16` | 0.0426807 s |
| local-metal-controlled-swap-q16-2026-07-10 | `same_day_cross_target_ratio.qpp_cpu_over_mklq_metal_controlled_swap_state_q16` | 5.67x |
...
| local-metal-four-qubit-resident-q20-2026-07-11 | `mklq_metal_elapsed_seconds_median.four_qubit_state_q20` | 0.173373 s |
| local-metal-four-qubit-resident-q20-2026-07-11 | `q20-four-qubit-resident.qpp_cpu_over_mklq_metal_four_qubit_state_q20` | 101.698 |
...
| --- | --- | --- | --- | --- | --- | --- |
| local-metal-controlled-swap-q16-2026-07-10 | controlled-swap-state | 16 | 1024 | `mklq_metal_resident_controlled_swap_state_host_readback` | resident fp32 Metal controlled built-in SWAP update followed by host readback for cudaq.get_state | benchmark_harness_static_case_map |
...
| local-metal-four-qubit-resident-q20-2026-07-11 | four-qubit-state | 20 | 1024 | `mklq_metal_resident_four_gate_state_host_readback` | resident fp32 Metal four-target gate update followed by host readback for cudaq.get_state | benchmark_harness_static_case_map |
