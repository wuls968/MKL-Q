...
| --- | ---: | ---: | ---: | --- |
| composite_fast_path | 9 | 0 | 0 | Composite circuit fast-path selection counter tests |
| controlled_single_qubit_fast_path | 55 | 0 | 0 | Controlled built-in single-qubit gate fast-path counter tests |
| multi_control_boundary | 9 | 0 | 0 | Multi-control generic specialized-path boundary tests |
| phase_fast_path | 15 | 0 | 0 | Diagonal phase gate fast-path counter tests |
| single_control_rz_phase | 9 | 0 | 0 | Single-control Rz direct phase fast-path counter tests |
| single_qubit_fast_path | 18 | 0 | 0 | Uncontrolled built-in single-qubit gate fast-path counter tests |
| three_qubit_fast_path | 10 | 0 | 0 | Three-qubit row-sparse and unit-permutation fast-path counter tests |
| two_qubit_fast_path | 26 | 0 | 0 | Two-qubit gate fast-path counter tests |
...
| three_qubit_fast_path | `mklq_cpu_MKLQCpuTester.UnitPermutationThreeQubitCustomOperationUsesDedicatedFastPath` |
| two_qubit_fast_path | `mklq_cpu_MKLQCpuTester.ControlledDenseTwoQubitBlockPathAppliesCustomGate` |
| two_qubit_fast_path | `mklq_cpu_MKLQCpuTester.ControlledSwapFastPathAppliesBuiltInGate` |
...
| benchmarks/mklq/reports/local-cpu-gate-counter-probe-2026-07-08-controlled-swap.cpu-gate-counter.json | 2026-07-08T10:38:06.135882+00:00 | passed | 21 | 21 | 0 | 21 | 0 |
...
| benchmarks/mklq/reports/local-cpu-gate-counter-probe-2026-07-10-unit-permutation.cpu-gate-counter.json | 2026-07-10T13:24:13.949275+00:00 | passed | 22 | 22 | 0 | 22 | 0 |
