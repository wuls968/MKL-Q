...
APPLE_WORKFLOW_REQUIRED_TOKENS = (
    ...
    "timeout-minutes:",
    "timeout-minutes: 20",
    "Prepare sparse source checkout",
    "GITHUB_WORKSPACE",
    "GITHUB_REF_NAME",
    "MKLQ_CHECKOUT_REF",
    "git check-ref-format --branch",
...
APPLE_WORKFLOW_FORBIDDEN_LINE_PATTERNS = (
    ...
    (re.compile(r"actions/checkout"), "actions/checkout"),
    (re.compile(r"^\s*filter:\s*blob:none\s*$", re.MULTILINE),
     "filter: blob:none checkout input"),
