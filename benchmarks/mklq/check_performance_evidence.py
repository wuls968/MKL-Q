...
DEFAULT_SUMMARY_ID = "local-clean-cpu-q20-2026-07-08-diagonal-phase"
...
DEFAULT_REQUIRED_RATIOS = (
    ...
    "cz_state_q20",
    "two_qubit_state_q20",
    "custom_two_qubit_state_q20",
    "dense_two_qubit_state_q20",
    "controlled_dense_two_qubit_state_q20",
