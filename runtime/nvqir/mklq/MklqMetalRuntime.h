...
public:
  ...
  bool applyResidentTwoQubitGate(const std::complex<double> *matrix,
                                 ...
                                 std::size_t controlCount,
                                 const std::size_t *targetQubits);
  bool applyResidentThreeQubitGate(const std::complex<double> *matrix,
                                   const std::size_t *controlQubits,
                                   std::size_t controlCount,
                                   const std::size_t *targetQubits);
  ...
  std::size_t residentProbabilityFillBufferAllocations() const;
  double residentProbabilityFillBufferPreparationSeconds() const;
  double residentProbabilityFillGateFlushSeconds() const;
